...
namespace Andrzejewski_48660_Projekt3_2Semestr
{
    class maGraniastosłup : maBryłaAbstrakcyjna
    {
        ...
        public maGraniastosłup(int maPromien, Color maKolorLinii, DashStyle maStylLinii, int maGruboscLinii, int maWysokosc, int maStopienWielokataPodstawy, Point maSrodekPodlogi) : base(maPromien, maKolorLinii, maStylLinii, maGruboscLinii)
        {
            maRodzajBryły = maTypBryły.maGraniastosłup;
        ...
        {
            // Ten graniastosłup nie będzie pochylany; Funkcja pusta;
        }
