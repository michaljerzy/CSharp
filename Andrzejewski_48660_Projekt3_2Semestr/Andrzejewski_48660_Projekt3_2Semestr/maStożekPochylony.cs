...
{
    class maStożekPochylony : maBryłaAbstrakcyjna
    {
        ...
        public maStożekPochylony(int maPromien, Color maKolorLinii, DashStyle maStylLinii, int maGruboscLinii, int maWysokosc, int maStopienWielokataPodstawy, Point maSrodekPodlogi, int maKątNachylenia) : base(maPromien, maKolorLinii, maStylLinii, maGruboscLinii)
        {
            maRodzajBryły = maTypBryły.maStożekPochylony;
            ...
            maSufit.X = maXŚrodkaPodłogi - (90 - maKątNachylenia);
        ...
        public override void maPrzesuńDoNowegoXY(int maX, int maY)
        {
            ...
            maSufit.X = maX - (90 - maKątPochylenia);
